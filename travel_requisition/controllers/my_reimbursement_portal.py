...
class AllMyExpense(http.Controller):
    @http.route('/my/MyReimbursement/', website=True, auth='user')
    ...
    @http.route(['/my/MyReimbursement/<model("hr.expense"):rexpense>'], type='http', auth='user', website=True)
    ...
    @http.route(['/attachment/download', ], type='http', auth='user', website=True)
    ...
    @http.route('/create/MyReimbursement', website=True, auth='user')
